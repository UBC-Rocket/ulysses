...
The project is a multi-phase plan, with the goal of a fully-featured prototype capable of returning to a specified point when dropped at a high altitude by 2027. The goal for the 2025 - 2026 academic year is as follows: 
...
| Phase 3 | Swapping from a PID-based control system to an MPC system; FPGA system; general polishing | LC 2025 |