...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    */
    ...
    handle_GPDMA2_Channel5.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT0 | DMA_DEST_ALLOCATED_PORT1; // Changed DEST to PORT1
    ...
    if (HAL_DMA_ConfigChannelAttributes(&handle_GPDMA2_Channel5, DMA_CHANNEL_NSEC | DMA_CHANNEL_NPRIV) != HAL_OK)
    {
      Error_Handler();
    }
  ...
  else if(huart->Instance==USART1)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_USART1; // Correct AF for PB14/15
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
    ...
    // ... (keep your existing GPDMA2_Channel0 init settings here)
    HAL_DMA_Init(&handle_GPDMA2_Channel0);
    __HAL_LINKDMA(huart, hdmatx, handle_GPDMA2_Channel0);
    // THIS TURNS ON THE UART INTERRUPT
  ...
  */
    ...
    PD6     ------> USART2_RX
    */
    // CORRECT - PA2=USART2_TX (D1), PA3=USART2_RX (D0)
